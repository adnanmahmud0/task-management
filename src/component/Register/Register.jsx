            ...
            <div className="bg-white max-w-md w-full shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md overflow-hidden p-8">
                ...
                <form className="space-y-6">
                    ...
                    <div>
                        ...
                        <input name="email" type="email" className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-2.5 rounded-md border focus:bg-transparent focus:border-black outline-none transition-all" placeholder="Enter email" />
                    </div>
                    <div>
                    ...
                    <button type="button" className="w-full py-3 px-6 text-sm tracking-wide rounded-md text-white bg-gray-800 hover:bg-gray-900 focus:outline-none transition-all">
                        Sign up
                    </button>
                </form>
